        ...
        jd: {
          ...
          structured: {
            ...
            responsibilities: [
              ...
              'Use Gong\'s own platform to analyze and improve your outreach',
...
Cold calling, email copywriting, objection handling, territory management`,
    ...
    const dryRun = {
      ...
      history: [
        ...
        { question: 'What does a bad prospecting day look like for you and how do you recover?', answer: 'A bad day is when I\'m going through the motions and the emails feel generic. I\'ve learned to notice that. When it happens I usually stop and do 20 minutes of deep research on one account, write one really good personalized email, and that resets my energy. Quality usually brings quantity back.' },
        { question: 'How do you prioritize your account list when you have 200 accounts to work?', answer: 'I tier them. Tier 1 is accounts that hit all my ICP criteria plus have a recent trigger — those get full personalization. Tier 2 gets a semi-personalized sequence. Tier 3 gets a high-volume sequence. I spend most of my time on Tier 1 and check in on the others.' },
      ...
      report: {
        ...
        question_feedback: [
          ...
          { question: 'How do you prioritize your account list when you have 200 accounts to work?', answer: 'I tier them...', feedback: 'Tiered approach is the right answer and you explained it clearly. Could be slightly more specific about what a "trigger" looks like in practice.', score: 72 },
        ...
        jd: {
          ...
          structured: {
            ...
            responsibilities: [
              ...
              'Use Crestline\'s platform to analyze and improve your outreach',
              'Collaborate with Enterprise AEs on named account strategy',
              'Consistently hit and exceed KPIs for calls, emails, and meetings set',
            ],
            must_have: [
